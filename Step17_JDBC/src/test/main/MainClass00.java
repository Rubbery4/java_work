...
public class MainClass00 extends JFrame implements ActionListener {
	
	JTextField inputnum, inputname, inputaddr;
	JLabel label;
	
	//생성자
	public MainClass00(String title) {
		super(title);
		// 초기 위치와 크기 설정
		...
		this.inputnum = new JTextField(10);
		this.inputname = new JTextField(10);
		this.inputaddr = new JTextField(10);
	...
	public void actionPerformed(ActionEvent e) {
		...
		// String 으로 값을 받았기 때문에 Int형으로 변경
